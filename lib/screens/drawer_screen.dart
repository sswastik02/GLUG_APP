            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(user.email,style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold))
                    ],
                  )
                ],
              ),
              ...
              Column(
                children: drawerItems.map((element) => Padding(
                  ...
                  child:
                  ListTile(
                    leading: Icon(element['icon'],color: Colors.white,size: 30,),
                    title: Text(element['title'],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18)),
                    onTap: () {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => element['class']));
                    },
                  ),
                )).toList(),
              ),
